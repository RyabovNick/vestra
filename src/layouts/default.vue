...
export default {
    ...
    return {
      ...
      items: [
        ...
        },
        {
          ...
          model: false,
          children: [
            { text: 'О разделе', link: '/development', access: false },
            { text: 'Клиент', link: '/development/client', access: false },
            {
              text: 'Сервис авторизации',
              link: '/development/auth',
              access: false,
            },
            {
              text: 'Сервис расписания',
              link: '/development/schedule',
              access: false,
            },
            {
              text: 'Сервис уведомлений',
              link: '/development/push',
              access: false,
            },
          ],
        },
  ...
  watch: {
    ...
    isAuthenticated(newV, oldV) {
      ...
      this.items[5].access = newV;
      for (const item of this.items[5].children) {
        item.access = newV;
      }
    },
  },
